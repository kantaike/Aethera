...
export type Denomination = components['schemas']['DenominationDto'];
export type DenominationRelation = components['schemas']['DenominationRelationDto'];
...
export type CreateDenominationRequest = components['schemas']['CreateDenominationCommand'];
...
export type AddDenominationTranslationRequest = components['schemas']['AddDenominationTranslationCommand'];
export type UpsertDenominationRelationRequest = components['schemas']['UpsertDenominationRelationCommand'];
